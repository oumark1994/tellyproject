...
<div class="container-fluid my-5">
        <div class="col-xl-4 col-lg-12 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="post" action="{{url('/addabout')}}" enctype="multipart/form-data">
        
                {{csrf_field()}}
                <div class="mb-3">
                  <input type="text" class="form-control" name="about" placeholder="Enter about us" aria-label="Name" aria-describedby="email-addon">
                </div>
