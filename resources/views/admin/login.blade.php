      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Login to your admin dashboard</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
           ...
           @endif
            ...
            <div class="card-body">
              <form role="form text-left" method="post" action="{{url('/signin')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="password" class="form-control" placeholder="password" name="password" aria-label="Email" aria-describedby="email-addon">
                  </div>
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{url('/myregister')}}" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
